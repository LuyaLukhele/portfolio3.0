    ...
    return (
        <div className="bg-gray-50 m-2 p-8 flex flex-col justify-center items-center border-solid border-2 rounded-sm border-stone-300">
            <div className="w-5/6 text-center sm:text-4xl text-5xl">
                ...
                <h2><span className='text-orange-500 relative inline-block after:content-[""] after:absolute after:left-0 after:right-0 after:-bottom-1 after:h-2 after:bg-orange-200 after:-z-10'>Software Engineer</span></h2>
